...
def main():
    ...
    summary = {
        ...
        "top1_positive_rate": round(top1_positive / len(module_rows), 4) if module_rows else 0.0,
        "top1_overlap_rate": round(top1_overlap / len(module_rows), 4) if module_rows else 0.0,
