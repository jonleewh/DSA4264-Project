...
def default_note(skill: str) -> str:
    return f"Canonical skill generated from baseline module skill rules ({skill})."
...
def build_framework(version: str = "v4") -> dict:
    ...
    return {
        ...
        "description": (
            ...
            "baseline create_test rule definitions and curated occupational skills."
        ),
        "fields": {
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Generate canonical_skill_framework_v4.json for the baseline create_test pipeline."
    )
    parser.add_argument(
        "--output",
        type=Path,
