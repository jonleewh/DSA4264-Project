...
DEFAULT_MODULE = FULL_DIR / "module_skills_canonical_stem.jsonl"
DEFAULT_JOB = FULL_DIR / "job_skills_canonical_stem.jsonl"
DEFAULT_OUTPUT = FULL_DIR / "module_job_alignment_STEM.json"
