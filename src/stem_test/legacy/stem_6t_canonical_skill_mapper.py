...
DEFAULT_STEM2_MODULE_TEST = PROJECT_ROOT / "data" / "test" / "module_descriptions_test_STEM.json"
DEFAULT_STEM2_JOB_TEST = PROJECT_ROOT / "data" / "test" / "job_descriptions_test_STEM.json"
DEFAULT_STEM3_MODULE_SKILLS = (
    PROJECT_ROOT / "data" / "test" / "module_descriptions_test_with_skills_independent_STEM.jsonl"
)
DEFAULT_STEM4_JOB_SKILLS = (
    PROJECT_ROOT / "data" / "test" / "job_ssoc345_with_skills_from_original_STEM.jsonl"
)
DEFAULT_STEM6_MODULE_OUTPUT = (
    PROJECT_ROOT / "data" / "test" / "module_skills_canonical_stem.jsonl"
)
DEFAULT_STEM6_JOB_OUTPUT = (
    PROJECT_ROOT / "data" / "test" / "job_skills_canonical_stem.jsonl"
)
...
def main():
    ...
    if run_pipeline_mode:
        prerequisite_paths = [
            ...
            ("stem_2 module test", DEFAULT_STEM2_MODULE_TEST),
            ("stem_2 job test", DEFAULT_STEM2_JOB_TEST),
